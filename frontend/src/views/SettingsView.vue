...
const apiDocsUrl = "https://ikhsan3adi.is-a.dev/polban-datacore-api-docs/";
    ...
    <div class="space-y-6 max-w-4xl mx-auto pb-10">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription
                    >Informasi akun administrator yang sedang
                    aktif.</CardDescription
                >
            </CardHeader>
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription
                    >Sesuaikan tema antarmuka dashboard.</CardDescription
                >
            </CardHeader>
            <CardContent>
                <div
                ...
                >
                    <div class="space-y-0.5">
                        ...
                        <p class="text-sm text-muted-foreground">
                            Mengubah tampilan menjadi warna gelap untuk
                            kenyamanan mata.
                        </p>
                    </div>
        ...
        <Card class="border-red-200 dark:border-red-900/50">
            ...
            <CardContent>
                <div class="flex items-center justify-between">
                    <p class="text-sm text-muted-foreground">
                        Keluar dari sesi administrator saat ini. Anda perlu
